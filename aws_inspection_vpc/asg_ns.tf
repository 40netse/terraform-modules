...
module "spk_tgw_gwlb_asg_fgt_igw" {
  ...
  existing_igw = {
    id = module.vpc-igw.igw_id
  }
  existing_tgw = {
  }
  existing_subnets = {
    fgt_login_az1 = {
      id = module.subnet-public-az1
      availability_zone = var.availability_zone_1
    },
    fgt_login_az2 = {
      id = module.subnet-public-az2
      availability_zone = var.availability_zone_2
    },
    gwlbe_az1 = {
      id = module.subnet-gwlbe-az1
      availability_zone = var.availability_zone_1
    },
    gwlbe_az2 = {
     id = module.subnet-gwlbe-az2
      availability_zone = var.availability_zone_2
    },
    fgt_internal_az1 = {
      id = module.subnet-private-az1
      availability_zone = var.availability_zone_1
    },
    fgt_internal_az2 = {
      id = module.subnet-private-az2
      availability_zone = var.availability_zone_2
    }
  }
          ...
          subnet = [
            {
              ...
              zone_name = var.availability_zone_1
            },
            {
              id = data.aws_subnet.public_subnet_az2[0].id
              zone_name = var.availability_zone_2
            }
          ]
          security_groups = [
            {
